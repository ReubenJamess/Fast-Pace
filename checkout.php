...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <h3>Table Number</h3>
      <p><i class="fas fa-concierge-bell"></i><span><?php if($fetch_profile['address'] == ''){echo 'please enter your table number';}else{echo $fetch_profile['address'];} ?></span></p>
      <a href="Table_No.php" class="btn">Confirm</a>
